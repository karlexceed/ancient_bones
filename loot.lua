...
ancient_bones.registered_loot = {
	...
	{name = "default:sword_steel", chance = 0.3},
	{name = "default:sword_diamond", chance = 0.05},
	{name = "default:pick_stone", chance = 0.4},
	{name = "default:pick_steel", chance = 0.2},
	{name = "default:pick_diamond", chance = 0.05},
	{name = "default:axe_stone", chance = 0.4},
	{name = "default:axe_steel", chance = 0.2},
